...
import { State, editProject } from "../lib/actions";
...
export default function EditProjectForm(props: any) {
    ...
    */
    ...
    function populateContentState() {
        ...
        // Sort project data, position ascending
        projectData.content.sort((a: any, b: any) => a.position - b.position);
    ...
    return (
        <form action={dispatch} className="flex flex-col p-2">
            ...
            <FlexTextAreaStateful
                ...
                initValue={projectData.projecturl}
                showLabel={true}
