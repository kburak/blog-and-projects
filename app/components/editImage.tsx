export default function editImage({
    ...
    return (
        <div className="p-4 relative">{/* // If to be deleted hide content. */}
            ...
            <input type="text" id="url" className="bg-gray-100" name={`${index}-${type}-url`} value={url} onChange={handleUrlUpdate} />

            <label htmlFor="caption">Caption</label>
            <input type="text" id="caption" className="bg-gray-100" name={`${index}-${type}-caption`} value={caption} onChange={handleCaptionUpdate} />
